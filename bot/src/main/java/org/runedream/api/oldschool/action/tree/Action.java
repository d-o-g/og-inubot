...
import org.runedream.api.oldschool.action.ActionFilter;
...
public abstract class Action implements ActionFilter { // An action has the ability to identify itself
    ...
    public static Action valueOf(int opcode, int arg0, int arg1, int arg2) {
        ...
        switch (opcode) {
            ...
            case ActionOpcodes.BUTTON_DIALOG: {
                return ButtonAction.valueOf(opcode, arg1, arg2);
            }
            case ActionOpcodes.ITEM_ACTION_0:
            case ActionOpcodes.ITEM_ACTION_1:
            case ActionOpcodes.ITEM_ACTION_2:
            case ActionOpcodes.ITEM_ACTION_3:
            case ActionOpcodes.ITEM_ACTION_4: {
                return new TableItemAction(opcode, arg0, arg1, arg2);
            }
            case ActionOpcodes.TABLE_ACTION_0:
            case ActionOpcodes.TABLE_ACTION_1:
            case ActionOpcodes.TABLE_ACTION_2:
            case ActionOpcodes.TABLE_ACTION_3:
            ...
            case ActionOpcodes.EXAMINE_ITEM: {
            ...
            case ActionOpcodes.ITEM_ON_ITEM: {
    ...
    public boolean isWalkHere() {
        return opcode == ActionOpcodes.WALK_HERE;
    }

    public boolean isUseItem() {
        return opcode == ActionOpcodes.USE_ITEM;
    }
     ...
     * False otherwise.
     */
    public boolean validate() { //TODO Implement to the rest
        return true;
    }
