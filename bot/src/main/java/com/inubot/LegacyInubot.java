...
/**
 * old code incase i fukd something up
 */
public class LegacyInubot extends JFrame implements Runnable {
    ...
    private static LegacyInubot instance;
    ...
    public static LegacyInubot getInstance() {
        return instance;
    }
