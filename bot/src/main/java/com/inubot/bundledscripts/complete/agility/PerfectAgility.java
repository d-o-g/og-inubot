...
//            Time.sleep(400);
    ...
    public enum Course {
        ...
        GNOME_COURSE(ObstacleFactory.nigger(true)
        ...
        VARROCK_COURSE(ObstacleFactory.nigger(true)
        ...
        FALADOR_COURSE(ObstacleFactory.nigger(true)
        ...
        SEERS_COURSE(ObstacleFactory.nigger(true)
        ...
        POLLNIVNEACH_COURSE(ObstacleFactory.nigger(true)
        ...
        RELLEKKA_COURSE(ObstacleFactory.nigger(true)
        ...
        ARDY_COURSE(ObstacleFactory.nigger(true)
    ...
    private static class ObstacleFactory {
        ...
        public static ObstacleFactory nigger(boolean clear) {
            if (clear)
                obstacles.clear();
            return new ObstacleFactory();
        }

        public static ObstacleFactory nigger() {
            return nigger(false);
        }
