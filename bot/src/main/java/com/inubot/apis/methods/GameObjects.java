...
import com.inubot.apis.oldschool.GameObject.Landmark;
import com.inubot.apis.oldschool.Locatable;
import com.inubot.apis.oldschool.collection.GameObjectPool;
...
public class GameObjects {
     ...
     * @return A {@link com.inubot.apis.oldschool.collection.GameObjectPool} which can be used for selection
     * by chain calls
     */
     ...
     * @return An array of {@link com.inubot.apis.oldschool.GameObject}'s at the specified position
     */
    ...
    /**
     * @param filter The {@link com.inubot.apis.util.filter.Filter} which should be used to select elements
     * @return an array of {@link com.inubot.apis.oldschool.GameObject}'s in the loaded region accepted
     * by the given filter
     */
    ...
    /**
     * @return An array of {@link com.inubot.apis.oldschool.GameObject}'s in the loaded region
     */
